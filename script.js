/*
  [최종 수정] '병원 자랑' 섹션의 내용을 상세하게 업데이트했습니다.
    ...
    if (data.main) {
        ...
        infoGrid.innerHTML = `
            <div class="info-card" style="grid-column:1/-1; border-top:none;">
                ...
                <p style="color:#d81b60; font-weight:bold; text-align:center; margin-bottom: 20px;">${data.main.hours.surgeryNotice}</p>
                <ul id="main-hours"></ul>
            </div>
        `;
