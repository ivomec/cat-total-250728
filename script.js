        ...
        if (idCell) {
            ...
            if (isHighlighted && selectedOption) {
                ...
                switch (category) {
                    ...
                    case '모니터링': 
                        idCell.style.backgroundColor = '#FF0000';
