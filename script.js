/*
  [중요] 이 파일의 모든 내용을 기존 script.js 파일에 덮어쓰기 하세요.
  기존 내용을 모두 지우고 붙여넣어야 합니다.
*/
document.addEventListener('DOMContentLoaded', () => {
    const hospitalData = {
        ...
        "packagesWith4Dx": [
          {
            ...
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 7종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 3컷(흉부)", "🩺 (5) 혈압체크", "<strong>❤️ (6) 심장사상충검사(4Dx)</strong>"],
            "originalPrice": 254000, "discountPrice": 199000
          },
          {
            "borderColor": "#ffd54f", "titleColor": "#f9a825", "title": "💪 7세 미만 성견 플랜 💪",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사", "<strong>❤️ (9) 심장사상충검사(4Dx)</strong>"],
            "originalPrice": 389000, "discountPrice": 299000
          },
          {
            "borderColor": "#ff8a65", "titleColor": "#d84315", "title": "👑 7세 이상 A2 플랜 👑",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사", "🦋 (9) SDMA검사(신장기능)", " hormon (10) T4검사(갑상선호르몬)", "✨ (11) 복부초음파", "<strong>❤️ (12) 심장사상충검사(4Dx)</strong>"],
            "originalPrice": 569000, "discountPrice": 439000
          },
          {
            "borderColor": "#ba68c8", "titleColor": "#7b1fa2", "title": "💎 7세 이상 B2 VIP 플랜 💎",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사", "🦋 (9) SDMA검사(신장기능)", " hormon (10) T4검사(갑상선호르몬)", "✨ (11) 복부초음파", "👀 (12) 안과 종합 검사", "<strong>❤️ (13) 심장사상충검사(4Dx)</strong>"],
            "originalPrice": 628000, "discountPrice": 489000
          },
          {
            "borderColor": "#228B22", "titleColor": "#228B22", "title": "🌳 큰 아이 맞춤설계 (7세미만, 20kg이상) 🌳",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "🧪 (5)CHEMI 7종 검사", "<strong>❤️ (6)심장사상충 검사</strong>", "💓 (7)Tnl 검사"],
            "originalPrice": 225400, "discountPrice": 180000
          },
          {
            "borderColor": "#FF8C00", "titleColor": "#FF8C00", "title": "🍂 큰 아이 맞춤설계 (7세이상, 20kg이상) 🍂",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "<strong>❤️ (5)심장사상충 검사</strong>", "🧪 (6)CHEMI 12종 검사", "💓 (7)Tnl 검사", " hormon (8)T4 검사", "🔥 (9)CRP 검사"],
            "originalPrice": 355400, "discountPrice": 284000
          },
          {
            "borderColor": "#B22222", "titleColor": "#B22222", "title": "🍁 큰 아이 맞춤설계 (7세이상 심화, 20kg이상) 🍁",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "<strong>❤️ (5)심장사상충 검사</strong>", "🧪 (6)CHEMI 12종 검사", "💓 (7)Tnl 검사", " hormon (8)T4 검사", "🔥 (9)CRP 검사", "🦋 (10)SDMA 검사"],
            "originalPrice": 425400, "discountPrice": 340000
          }
        ],
        "packagesWithout4Dx": [
          {
            "borderColor": "#4db6ac", "titleColor": "#00796b", "title": "🍼 1세 미만 퍼피 플랜 🍼",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 7종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 3컷(흉부)", "🩺 (5) 혈압체크"],
            "originalPrice": 209000, "discountPrice": 154000
          },
          {
            "borderColor": "#ffd54f", "titleColor": "#f9a825", "title": "💪 7세 미만 성견 플랜 💪",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사"],
            "originalPrice": 344000, "discountPrice": 254000
          },
          {
            "borderColor": "#ff8a65", "titleColor": "#d84315", "title": "👑 7세 이상 A2 플랜 👑",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사", "🦋 (9) SDMA검사(신장기능)", " hormon (10) T4검사(갑상선호르몬)", "✨ (11) 복부초음파"],
            "originalPrice": 524000, "discountPrice": 394000
          },
          {
            "borderColor": "#ba68c8", "titleColor": "#7b1fa2", "title": "💎 7세 이상 B2 VIP 플랜 💎",
            "items": ["🩸 (1) 혈구검사", "🧪 (2) 혈액화학검사 12종", "⚡️ (3) 전해질검사", "🩻 (4) X-RAY 5컷(흉부,복부)", "🩺 (5) 혈압체크", "🔥 (6) CRP검사(염증수치)", "❤️‍🩹 (7) 심전도검사", "💧 (8) 뇨검사", "🦋 (9) SDMA검사(신장기능)", " hormon (10) T4검사(갑상선호르몬)", "✨ (11) 복부초음파", "👀 (12) 안과 종합 검사"],
            "originalPrice": 583000, "discountPrice": 444000
          },
          {
            "borderColor": "#228B22", "titleColor": "#228B22", "title": "🌳 큰 아이 맞춤설계 (7세미만, 20kg이상) 🌳",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "🧪 (5)CHEMI 7종 검사", "💓 (6)Tnl 검사"],
            "originalPrice": 180400, "discountPrice": 150000
          },
          {
            "borderColor": "#FF8C00", "titleColor": "#FF8C00", "title": "🍂 큰 아이 맞춤설계 (7세이상, 20kg이상) 🍂",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "🧪 (5)CHEMI 12종 검사", "💓 (6)Tnl 검사", " hormon (7)T4 검사", "🔥 (8)CRP 검사"],
            "originalPrice": 310400, "discountPrice": 254000
          },
          {
            "borderColor": "#B22222", "titleColor": "#B22222", "title": "🍁 큰 아이 맞춤설계 (7세이상 심화, 20kg이상) 🍁",
            "items": ["🩺 (1)기본 진료비", "💉 (2)채혈비", "❤️‍🩹 (3)혈압 체크", "🩸 (4)CBC 검사", "🧪 (5)CHEMI 12종 검사", "💓 (6)Tnl 검사", " hormon (7)T4 검사", "🔥 (8)CRP 검사", "🦋 (9)SDMA 검사"],
            "originalPrice": 380400, "discountPrice": 310000
          }
        ],
        "explanation": {
        ...
        "packages": [
          {
            ...
            "items": ["💧 술 전 수액 처치", "💉 술 전 주사 마취", "😴 호흡 마취 <small>(기본 1시간)</small>", "📸 전체 치과 X-ray <small>(10장 이상 꼼꼼 촬영!)</small>", "🧼 스케일링", "💎 폴리싱"],
            "originalPrice": 462000, "discountPrice": 239000
          },
          {
            "borderColor": "#ffc107", "titleColor": "#ffc107", "title": "🐕 5kg ~ 10kg 🐕",
            "items": ["💧 술 전 수액 처치", "💉 술 전 주사 마취", "😴 호흡 마취 <small>(기본 1시간)</small>", "📸 전체 치과 X-ray <small>(10장 이상 꼼꼼 촬영!)</small>", "🧼 스케일링", "💎 폴리싱"],
            "originalPrice": 523000, "discountPrice": 299000
          },
          {
            "borderColor": "#20c997", "titleColor": "#20c997", "title": "🐕‍🦺 10kg ~ 15kg 🐕‍🦺",
            "items": ["💧 술 전 수액 처치", "💉 술 전 주사 마취", "😴 호흡 마취 <small>(기본 1시간)</small>", "📸 전체 치과 X-ray <small>(10장 이상 꼼꼼 촬영!)</small>", "🧼 스케일링", "💎 폴리싱"],
            "originalPrice": 604000, "discountPrice": 388000
          },
          {
            "borderColor": "#4dabf7", "titleColor": "#1c7ed6", "title": "🐾 15kg ~ 20kg 🐾",
            "items": ["💧 술 전 수액 처치", "💉 술 전 주사 마취", "😴 호흡 마취 <small>(기본 1시간)</small>", "📸 전체 치과 X-ray <small>(10장 이상 꼼꼼 촬영!)</small>", "🧼 스케일링", "💎 폴리싱"],
            "originalPrice": 675000, "discountPrice": 399000
          },
          {
            "borderColor": "#845ef7", "titleColor": "#845ef7", "title": "듬직한 20kg 이상",
            "items": ["💧 술 전 수액 처치", "💉 술 전 주사 마취", "😴 호흡 마취 <small>(기본 1시간)</small>", "📸 전체 치과 X-ray <small>(10장 이상 꼼꼼 촬영!)</small>", "🧼 스케일링", "💎 폴리싱"],
            "originalPrice": 746000, "discountPrice": 439000
          }
        ],
        "explanation": {
      ...
      "extraction": {
        ...
        "costs": [
            { "title": "🦷 뿌리 1개 발치 (앞니 등)", "description": "<strong>일반 쏙!:</strong> 많이 흔들리는 치아<br><strong>수술 샥!:</strong> 잇몸 절개&봉합 포함", "prices": [{ "label": "일반 (10kg 이하)", "value": "22000" }, { "label": "일반 (10kg 이상)", "value": "33000" }, {"label": "수술 (10kg 이하)", "value": "44000"}, {"label": "수술 (10kg 이상)", "value": "66000"}] },
            { "title": "🦷🦷 뿌리 2개 발치 (작은어금니)", "description": "<strong>일반 쏙! :</strong> 많이 흔들리는 치아<br><strong>수술 샥! :</strong> 잇몸 절개&봉합 포함", "prices": [{ "label": "일반 (10kg 이하)", "value": "66000" }, { "label": "일반 (10kg 이상)", "value": "77000" }, {"label": "수술 (10kg 이하)", "value": "120000"}, {"label": "수술 (10kg 이상)", "value": "140000"}] },
            { "title": "🦷🦷🦷 뿌리 3개 발치 (큰어금니)", "description": "<strong>일반 쏙! :</strong> 많이 흔들리는 치아<br><strong>수술 샥! :</strong> 잇몸 절개&봉합 포함", "prices": [{ "label": "일반 (10kg 이하)", "value": "88000" }, { "label": "일반 (10kg 이상)", "value": "110000" }, {"label": "수술 (10kg 이하)", "value": "220000"}, {"label": "수술 (10kg 이상)", "value": "320000"}] },
            { "title": "💪 튼튼한 송곳니 수술 발치", "description": "길고 튼튼한 송곳니 뿌리! 정교한 수술로 안전하게 제거해요.", "prices": [{ "label": "위턱 (10kg 이하)", "value": "220000" }, { "label": "위턱 (10kg 이상)", "value": "320000" }, { "label": "아래턱 (10kg 이하)", "value": "270000" }, { "label": "아래턱 (10kg 이상)", "value": "370000" }] },
            { "title": "💥 대구치(M1) & 열육치(P4) 발치", "description": "가장 크고 중요한 어금니들을 발치해요!", "prices": [{ "label": "일반 (10kg 이하)", "value": "88000" }, { "label": "일반 (10kg 이상)", "value": "110000" }, { "label": "수술 (10kg 이하)", "value": "220000" }, { "label": "수술 (10kg 이상)", "value": "320000" }] },
            { "title": "🍼 유치 발치", "description": "빠져야 할 시기에 빠지지 않은 유치를 안전하게 제거해요.", "prices": [{ "label": "단순 발치 (10kg 이하)", "value": "22000" }, { "label": "단순 발치 (10kg 이상)", "value": "33000" }, { "label": "수술 발치 (10kg 이하)", "value": "44000" }, { "label": "수술 발치 (10kg 이상)", "value": "66000" }] }
        ],
        "explanation": {
      ...
      "addons": {
        ...
        "large": {
          ...
          "costs": [
              ...
              { "borderColor": "#4dd0e1", "titleColor": "#00838f", "title": "🚀 빠른 회복", "prices": [{ "label": "💉 항생/소염 주사", "value": "15,000원 ~" }, { "label": "⏰ 1주 지속 항생/소염 주사", "value": "20,000원 ~" }, { "label": "✨ 불소 도포", "value": "45,000원 ~" }] },
              { "borderColor": "#9575cd", "titleColor": "#512da8", "title": "🏡 홈케어 용품", "prices": [{ "label": "👑 넥카라", "value": "12,000원 ~" }, { "label": "💧 액상 진통제(3일분)", "value": "32,000원" }, { "label": "🌿 구강소독 헥시딘 스프레이", "value": "10,000원" }, { "label": "🩹 구강항생연고(페리덱스)", "value": "33,000원" }, {"label": "👄 구강점막 코팅 스프레이(뮤코딘)", "value": "33,000원"}] }
          ],
          "explanation": {
            "title": "💡 꼭 확인해주세요! 🤔",
            "content": [
              "안내된 비용은 <strong>15kg 아이를 기준</strong>으로 한 최소 시작 금액이며, 아이의 체중에 따라 비용이 달라질 수 있습니다.",
              "모든 항목은 아이의 상태에 따라 수의사 선생님과 상의 후 결정되니 안심하세요.",
              "정확한 전체 비용을 안내드리지 못하는 점 너른 양해 부탁드립니다. 🙏"
            ]
          }
...
function initCalculator() {
    ...
    function populateAdditionalTreatments() {
        ...
        tbody.innerHTML = '';
        // Using a simplified hardcoded version for cats based on the old inline script
        const treatments = [
    ...
    function loadData(event) {
        ...
        reader.onload = (e) => {
            try {
                ...
                updateAdditionalOptions(); // Call again to ensure costs are updated after loading
                updateDynamicTitle();
                page.querySelectorAll('.main-container tr').forEach(updateRowHighlight);
                isChartDirty = false;
